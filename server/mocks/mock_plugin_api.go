...
func (m *MockAPI) GetPreferenceForUser(arg0, arg1, arg2 string) (model.Preference, *model.AppError) {
	m.ctrl.T.Helper()
...
func (m *MockAPI) GetUsersByIds(arg0 []string) ([]*model.User, *model.AppError) {
	m.ctrl.T.Helper()
...
func (m *MockAPI) InviteRemoteToChannel(arg0, arg1, arg2 string, arg3 bool) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "InviteRemoteToChannel", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (m *MockAPI) PatchChannelMembersNotifications(arg0 []*model.ChannelMemberIdentifier, arg1 map[string]string) *model.AppError {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PatchChannelMembersNotifications", arg0, arg1)
	ret0, _ := ret[0].(*model.AppError)
	return ret0
}
...
func (m *MockAPI) RegisterPluginForSharedChannels(arg0 model.RegisterPluginOpts) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RegisterPluginForSharedChannels", arg0)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAPI) SendPushNotification(arg0 *model.PushNotification, arg1 string) *model.AppError {
	m.ctrl.T.Helper()
...
func (m *MockAPI) SetFileSearchableContent(arg0, arg1 string) *model.AppError {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetFileSearchableContent", arg0, arg1)
	ret0, _ := ret[0].(*model.AppError)
	return ret0
}
...
func (m *MockAPI) ShareChannel(arg0 *model.SharedChannel) (*model.SharedChannel, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ShareChannel", arg0)
...
func (m *MockAPI) SyncSharedChannel(arg0 string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SyncSharedChannel", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (m *MockAPI) UninviteRemoteFromChannel(arg0, arg1 string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UninviteRemoteFromChannel", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (m *MockAPI) UnregisterPluginForSharedChannels(arg0 string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UnregisterPluginForSharedChannels", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (m *MockAPI) UnshareChannel(arg0 string) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UnshareChannel", arg0)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAPI) UpdateSharedChannel(arg0 *model.SharedChannel) (*model.SharedChannel, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateSharedChannel", arg0)
	ret0, _ := ret[0].(*model.SharedChannel)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAPI) UpdateSharedChannelCursor(arg0, arg1 string, arg2 model.GetPostsSinceForSyncCursor) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateSharedChannelCursor", arg0, arg1, arg2)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (m *MockAPI) UpdateUserAuth(arg0 string, arg1 *model.UserAuth) (*model.UserAuth, *model.AppError) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateUserAuth", arg0, arg1)
...
func (m *MockAPI) UpdateUserRoles(arg0, arg1 string) (*model.User, *model.AppError) {
	m.ctrl.T.Helper()

...
func generateGoFile(filename string, aliasToIndex map[string]int, indexToUnicode map[int]string) error {
	...
	writer.WriteString("// This file is auto-generated from Mattermost's emoji mapping data\n")
	writer.WriteString("// Do not edit manually - regenerate using tools/emoji_generator.go\n\n")

	// Write emojiNameToIndex map
	writer.WriteString("// emojiNameToIndex maps emoji names to indices (from EmojiIndicesByAlias)\n")
	writer.WriteString("var emojiNameToIndex = map[string]int{\n")
	...
	writer.WriteString("// emojiIndexToUnicode maps indices to Unicode hex codes (from EmojiIndicesByUnicode)\n")
	writer.WriteString("var emojiIndexToUnicode = map[int]string{\n")
